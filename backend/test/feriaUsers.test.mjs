...
import { adminRoleOf, validateSellerInput, validateAdminInput, SUPERADMIN_EMAIL } from '../feriaUsers.mjs';
...
test('validateAdminInput: email, nombre, rol caja o logística; contraseña obligatoria al crear', () => {
  ...
  assert.throws(() => validateAdminInput({ email: 'a@b.com', name: 'X', password: 'secreta1', role: 'superadmin' }, { isNew: true }), /Rol/);
